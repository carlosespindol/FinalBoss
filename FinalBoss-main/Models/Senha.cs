...
namespace Models
{
    public class Senha
    {
        ...
        public Senha(
            string Nome, int CategoriaId, string Url, string Usuario, string SenhaEncrypt, string Procedimento
        )
        {
            this.Nome = Nome; this.CategoriaId = CategoriaId; this.Url = Url; this.Usuario = Usuario; this.SenhaEncrypt = SenhaEncrypt; this.Procedimento = Procedimento;
        ...
        public static void AlterarSenha(
            int Id, string Nome, int CategoriaId, string Url, string Usuario, string SenhaEncrypt, string Procedimento
        )
