...
namespace Telas
{
    public class CadSenha : Form
    {
        ...
        public CadSenha(Form parent)
        {
            ...
            this.lblCategoria = new Campos.LabelField("Categoria:", 30, 130);
            ...
            btnVoltar = new Campos.ButtonField("Retornar", 50, 750, 100, 30);
			btnVoltar.Click += new EventHandler(this.btnVoltarClick);

            btnInsert = new Campos.ButtonField("Confirme", 150, 750, 100, 30);
            ...
            this.Text = "Cadastrar uma nova senha";
        }
        ...
        {
            string message = "Sua senha foi cadastrada com sucesso!";
